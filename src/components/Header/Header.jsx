...
const Navbar = ({ activePage = "/" }) => {
  ...
  return (
    <motion.header
      ...
      initial="hidden"
      animate="visible"
      className={`fixed top-0 w-full z-[999] transition-all duration-300 ease-in-out hover:scale-105${scrolled
          ? "bg-[#0f172a80] backdrop-blur-md shadow-md border-b border-[#6366f110]"
          : "bg-transparent"
        }`}
    >
            ...
            >
                ...
                return (
                  <motion.li key={item.name} variants={itemVariants}>
                    <Link href={item.path} legacyBehavior>
                      <a
                        className={`flex items-center px-3 py-2 text-sm font-medium rounded-full transition-all ${isActive === item.path
                            ? "text-white  border-l-[3px] border-purple-padrao"
                            : "text-gray-300 hover:text-white hover:bg-[#6366f150]"
                          }`}
                        onClick={() => {
              ...
              <motion.li variants={itemVariants} className="ml-3">
                <a
                  ...
                  className="flex items-center px-4 py-2 text-sm font-medium rounded-full bg-purple-padrao text-white hover:bg-[#4f46e5] transition-all transform hover:scale-105"
                >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="relative z-[99] md:hidden bg-[#0f172a95] backdrop-blur-md border-b border-primary-[#6366f110]"
          >
            <div className="px-2 py-3 space-y-1 z-[99]">
              {navItems.map((item) => (
                ...
                >
                  <a
                    className={`flex items-center px-3 py-2 text-base font-medium rounded-lg ${isActive === item.path
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center px-3 py-2 text-base font-medium rounded-lg text-white bg-[#697fff] hover:bg-purple-padrao"
              >
